...
arithExpr
       ...
       | geom '.distance(' geom ')'                   # GeometryDistance 
       ;
...
geom
       ...
       | geom '.buffer(' num=( INT_LITERAL | REAL_LITERAL) ')'             # GeometryBuffer 
       ...
       | geom '.convexHull()'                         # GeometryConvexHull 
       | geom '.centroid()'                           # GeometryCentroid 
       | geom '.envelope()'                   # GeometryEnvelope 
       ;
