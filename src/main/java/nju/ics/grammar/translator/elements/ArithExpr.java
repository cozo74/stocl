...
public class ArithExpr extends OCLElement{
    ...
    boolean isRelation, isLiteral, isSubQueryOrRexNode; // true: relation (RelNode), false: literal or scalar (RexNode)

    Literal literal; // when isRelation is false and isLiteral is true, store the literal value

    RexNode scalarOrRexNode; //when isRelation is false and isLiteral is false, store the RexSubQuery value
